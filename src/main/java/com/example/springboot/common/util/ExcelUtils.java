...
public class ExcelUtils {
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, int sheetSize, OutputStream os) throws Exception {
...
//            throw new ExcelException("数据源中没有任何数据");
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, OutputStream os) throws Exception {
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, int sheetSize, HttpServletResponse response) throws Exception{
        // 文件名默认设置为当前时间：年月日时分秒
        ...
        try {
            response.setHeader("Content-disposition", "attachment;filename=" +  java.net.URLEncoder.encode(sheetName,"UTF-8") + ".xls");
     ...
     */
    public static <T> void listToExcel(List<T> list, Map<String, String> fieldMap, String sheetName, HttpServletResponse response) throws Exception {
     ...
     */
    private static <E> void fillSheet(WritableSheet sheet, List<E> list, Map<String, String> fieldMap, int firstIndex, int lastIndex) throws Exception {
        // 定义存放英文字段名和中文字段名的数组
        int size = fieldMap.size();
        String[] enFields = new String[size];
        String[] cnFields = new String[size];
     ...
     */
    public static <T> List<T> excelToList(InputStream is, String sheetName, Class<T> entityClass, LinkedHashMap<String, String> fieldMap, String[] uniqueFields) throws Exception {
        // 定义要返回的list
